  ...
  return (
    <div style={containerStyle} className={className}>
      <div style={starContainerStyle}>
        {/* // Kreiramo array od 5 elemenata. Funkcija prima dva argumenta:
         // prvi je element, a drugi je indeks. Stavljamo podvlaku (_) umjesto imena
        // jer nam element ne treba i želimo pokazati da ga ignoriramo. */}
